...
# 定义环境变量
export WEIGHT_ROOT="$WEIGHT_BASE_ROOT/Drone_mixout73/train_server/yolov8n/weights"
#export WEIGHT_ROOT="/home/igs/yhj_demo/v8/runs/Dronecoco55/train_small_opt/Dronecoco55_yolov8_small1/weights"

export RKNN_ROOT="/home/igs/yhj_demo/RknnProjects/rknn_model_zoo/"
...
cd /home/igs/yhj_demo/RknnProjects/rknn_model_zoo
...
scp  -r $RKNN_ROOT/install root@192.168.1.36:/root/yhj_demo/Project/rknn_model_zoo/install

## 下面是在服务器上运行，root@192.168.254.198，密码root，
ssh root@192.168.1.36 <<EOF
# rm -rf /root/yhj_demo/Project/rknn_model_zoo/install
cd /root/yhj_demo/Project/rknn_model_zoo/install/rk3588_linux_aarch64/rknn_yolov8_demo/
